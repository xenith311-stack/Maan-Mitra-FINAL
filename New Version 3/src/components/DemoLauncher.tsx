...
const DemoLauncher: React.FC<DemoLauncherProps> = ({ onLaunchDemo }) => {
  ...
  const demos = [
    ...
    {
      id: 'themes',
      title: '🎨 Multi-Theme System Demo',
      description: 'Experience WhatsApp, Forest, and Ocean themes with smooth transitions',
      status: 'Ready',
      features: [
        'WhatsApp theme with familiar green accents',
        'Forest theme with calming nature elements',
    ...
    },
    {
      ...
      features: [
        ...
        'Real-time adaptation based to engagement',
