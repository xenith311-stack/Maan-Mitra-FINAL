...
const App: React.FC = () => {
  const [currentView, setCurrentView] = useState<'launcher' | 'assessment' | 'activities' | 'insights' | 'themes'>('launcher');
  ...
  const demos = [
    ...
    },
    {
      ...
      description: 'Experience WhatsApp, Forest, and Ocean themes',
      status: '✅ Implemented'
    },
    {
      id: 'activities',
  ...
  if (currentView === 'launcher') {
    return (
      <ThemeProvider>
        <DemoLauncher onLaunchDemo={handleLaunchDemo} />
      </ThemeProvider>
    );
  }
