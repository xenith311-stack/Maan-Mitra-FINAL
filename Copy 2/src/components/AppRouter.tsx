...
const AssessmentFormWrapper: React.FC = () => {
  ...
  // You might want state here to choose between 'phq9', 'gad7', etc.
  // For now, let's default to PHQ-9
  const assessmentType = 'phq9';

  const handleComplete = (results: any) => {
    console.log('Assessment Completed:', results);
    // Navigate back to dashboard or show results page
    navigate('/dashboard');
    toast.success(`Completed ${assessmentType.toUpperCase()} assessment!`);
  };
