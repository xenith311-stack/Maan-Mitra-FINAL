  ...
  return (
    <div className="relative min-h-screen p-4 md:p-6">
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 md:mb-8 space-y-4 sm:space-y-0">
          <div className="flex items-center">
            <Button
              ...
              className="mr-3 md:mr-4 hover:bg-primary/10"
            >
              <ArrowLeft className="w-4 h-4" />
            </Button>
            <h1 className="text-lg md:text-xl font-semibold">Journal & Vent</h1>
          </div>
        ...
        {/* New Entry */}
        <Card className={`p-4 md:p-6 mb-6 md:mb-8 bg-card ${editingEntry ? 'border-yellow-400 border-2' : 'border-primary/20'}`}>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-2 sm:space-y-0">
            <div className="flex items-center flex-wrap gap-2">
              <BookOpen className="w-4 h-4 md:w-5 md:h-5 text-primary mr-2" />
